import { Message } from "../support/message.support"
...
export class Endpoint {
  ...
  /**
   * @description
   *  Genera el string de query params en base a un objeto
   */
  public static queryParams<T extends object>(params: T): string {
